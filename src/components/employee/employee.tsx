            ...
            <>
                {
                    editModeLastName
                        ...
                        :
                        <td onDoubleClick={() => activateEditMode('editModeLastName')}>{currentLastName}</td>
                }

                {
                    editModeName
                        ...
                        :
                        <td onDoubleClick={() => activateEditMode('editModeName')}>{currentName}</td>
                }

                {
                    editModeJobTitle
                        ...
                        :
                        <td onDoubleClick={() => activateEditMode('editModeJobTitle')}>{currentJobTitle}</td>
                }
                <td>
